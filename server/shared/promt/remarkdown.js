...
async function remarkdown(content) {
    const PROMPT = `Translate the following paragraph into professional Markdown format display (bold, italics, numbering, line breaks, justify...). Example: increasing the font size use #.`
